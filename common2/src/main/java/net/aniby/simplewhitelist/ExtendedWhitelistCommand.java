...
public class ExtendedWhitelistCommand<T extends WhitelistProfile> {
    private static final String permission = "simplewhitelist.command";

    private final CommandDispatcher<T> dispatcher;
    private final WhitelistPlugin plugin;

    public ExtendedWhitelistCommand(CommandDispatcher<T> dispatcher,
    ...
    public void register() {
        final LiteralArgumentBuilder<T> builder =
                Commands.literal("simplewhitelist")
                        ...
                        .executes(this::help);
        LiteralCommandNode<T> command = this.dispatcher.register(builder);
